...
Коли ви перевизначаєте віртуальну функцію в похідному класі, можна випадково допустити помилку в сигнатурі функції. 
Якщо сигнатура неправильна, компілятор не буде розглядати цю функцію як перевизначення, 
а створить нову функцію (на етапі компіляції показує помилки).

+ Ключове слово final - забороняє наслудування та перевизначення

- Що таке раннє і пізнє зв'язування? 
- Таблиця віртуальних функцій (vtable) */
